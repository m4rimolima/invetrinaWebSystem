...
<div class="container mx-auto p-6 bg-white">
    <h1 class="text-3xl font-bold mb-6 text-[#333D29] text-center">Dashboard</h1>

    <!-- Cards de Estatísticas -->
    <div class="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-6 mb-8">
        <div class="bg-white border border-[#A4AC86] rounded-2xl shadow-md p-6 text-center hover:shadow-xl transition">
    ...
    <div class="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-6 mb-8">
        <a href="{{ route('artists.create') }}" class="bg-[#7F4F24] text-white px-6 py-3 rounded-2xl shadow hover:bg-[#582F0E] text-center transition">+ Novo artista</a>
        <a href="{{ route('obras.create') }}" class="bg-[#A4AC86] text-[#333D29] px-6 py-3 rounded-2xl shadow hover:bg-[#656D4A] hover:text-white text-center transition">+ Nova obra</a>
        <a href="{{ route('exposicoes.create') }}" class="bg-[#656D4A] text-white px-6 py-3 rounded-2xl shadow hover:bg-[#333D29] text-center transition">+ Nova exposição</a>
        <a href="{{ route('logisticas.create') }}" class="bg-[#333D29] text-white px-6 py-3 rounded-2xl shadow hover:bg-black text-center transition">+ Nova logística</a>
    </div>

    <!-- Últimos registros -->
    <div class="grid grid-cols-1 lg:grid-cols-2 gap-6">
        <!-- Últimos artistas -->
        <div class="bg-white border border-[#A4AC86] rounded-2xl shadow-md p-6">
